...
-(NSString *) getUniqueDeviceIdentifierAsString
{
    ...
    NSString *strApplicationUUID = [SSKeychain passwordForService:appName account:@"com.safenetlabs.monkauth"];
    if (strApplicationUUID == nil)
    {
        ...
        [SSKeychain setPassword:strApplicationUUID forService:appName account:@"com.safenetlabs.monkauth"];
    }
